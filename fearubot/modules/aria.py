...
from fearubot import CMD_HELP, LOGS, TEMP_DOWNLOAD_DIRECTORY
from fearubot.events import register
from fearubot.utils import humanbytes
...
async def show_all(event):
    ...
    if len(msg) <= 4096:
        ...
        await event.edit("Output terlalu besar, akan dikirim sebagai file...")
...
async def check_metadata(gid):
    ...
    LOGS.info("Mengubah GID " + gid + " to" + new_gid)
    return new_gid
